...
NativeInteger_decode_bner(const asn_codec_ctx_t *opt_codec_ctx,
                          ...
                          void **nint_ptr, const void *buf_ptr, size_t size,
 ...
 */
asn_enc_rval_t
NativeInteger_encode_bner(const asn_TYPE_descriptor_t *sd, const void *ptr,
                          ...
                          asn_app_consume_bytes_f *cb, void *app_key)
{
	...
	/* Encode fake INTEGER */
	erval = INTEGER_encode_bner(sd, &tmp, tag_mode, tag, cb, app_key);
	if(erval.encoded == -1) {
